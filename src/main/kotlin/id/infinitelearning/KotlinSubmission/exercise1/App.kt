 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Novi", "Coco", "Nabila", "Bagas", "Lisa","Ali")
 ...
 */
fun totalMember(): Int {
    val mentor = arrayOf("jesika", "Shasa", "Hasan", "Reza")
    val countOfGroup = 6
...
fun main() {
     ...
     *
     */
    groupDetail(4, listOf("Novi", "Coco", "Nabila", "Bagas", "Lisa","Ali"), "Morning")
